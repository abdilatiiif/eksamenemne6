...
function Navigation() {
  return (
    <div className="bg-green-300 flex items-center justify-between px-4 p-2">
      <Link
        href="/"
      ...
      <nav className="hidden md:flex gap-3 ">
        <Link href="/" className="hover:text-green-200 transition font-medium">
          <button className="relative mt-5 p-2 text-md text-white overflow-hidden rounded-full group ">
